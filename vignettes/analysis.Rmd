...
The following chunk performs the additional simulation study with non-linearly prior effects.
...
```{r sim_extra,echo=TRUE,eval=FALSE}
set.seed(1)
...
prior <- sign(beta)*abs(beta)^3 + stats::rnorm(p,sd=0.1)
