...
remotes::install_github("LCSB-BDS/transreg") # ref="9ef767ed", version 1.0.0
rm(pkgs)
```
...
```{r computation_time,eval=FALSE,echo=FALSE}
# Synthetic example with measurement of computation time (for revision).
set.seed(1)
n <- 100
p <- 1000
m <- 3
