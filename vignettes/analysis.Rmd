...
This chunk empirically and analytically obtains the upper $95\%$ confidence interval of a random classifier with $n_1$ controls and $n_2$ cases. The result ($0.524$ for $766 + 790$ samples) is reported in the figure of the internal application.
