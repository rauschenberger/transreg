...
```{r ncerpd_plot,eval=TRUE,echo=TRUE}
#<<init>>
...
1*(median<=0.05) # integrate this in plot
...
grDevices::pdf(file=paste0(dir,"/manuscript/figure_cor.pdf"),width=8,height=6,pointsize=15)
...
```{r ncerpd_devel_stability,eval=FALSE,echo=FALSE}
#----- This temporary code chunk will be removed! -----
#<<init>>
...
```{r ncerpd_devel_testing,echo=FALSE,eval=FALSE}
#----- This temporary code chunk will be removed! -----
