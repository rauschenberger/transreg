...
subtitle: "$\\qquad \\qquad$ Armin Rauschenberger$~^{1,*}$ \\orcidlink{0000-0001-6498-4801}, Zied Landoulsi$~^{1}$ \\orcidlink{0000-0002-2327-3904}, \\newline Mark A. van de Wiel$~^{2,3,\\dagger}$ \\orcidlink{0000-0003-4780-8472}, Enrico Glaab$~^{1,\\dagger}$ \\orcidlink{0000-0003-3977-7469}"
...
for(scale in c("exp","iso")){
  for(alpha in c("0","1")){
    ...
    for(method in c("glmnet",paste0("transreg_",scale,c("_lp","_mf")),"naive")){
      lty <- switch(method,"mean"=1,"glmnet"=1,"transreg_exp_lp"=2,"transreg_exp_mf"=2,"transreg_iso_lp"=2,"transreg_iso_mf"=2,"naive"=3)
      col <- switch(method,"mean"="grey","glmnet"="black","transreg_exp_lp"=rgb(0.2,0.2,1),"transreg_iso_lp"=rgb(0.2,0.2,1),"transreg_exp_mf"=rgb(0,0,0.6),"transreg_iso_mf"=rgb(0,0,0.6),"naive"="red")
